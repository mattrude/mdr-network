...
class milly_keep_in_touch_widget extends WP_Widget {
  ...
  function widget($args, $instance) {
    ...
    echo "  .keep-in-touch li#feed { background: url(/wp-content/mu-plugins/images/keep-in-touch.png) no-repeat scroll 0 1px transparent; }";
    echo "  .keep-in-touch li#twitter { background: url(/wp-content/mu-plugins/images/keep-in-touch.png) no-repeat scroll 0 -28px transparent; }";
    echo "  .keep-in-touch li#facebook { background: url(/wp-content/mu-plugins/images/keep-in-touch.png) no-repeat scroll 0 -58px transparent; }";
    echo "  .keep-in-touch li#feed a { padding: 0 0 0 10px; }";
    echo "  .keep-in-touch li#twitter a { padding: 0 0 0 10px; }";
    echo "  .keep-in-touch li#facebook a { padding: 0 0 0 10px; }";
    echo "</style>";
